import { StyleSheet, Text, View, Image, Share, TouchableOpacity, FlatList, Dimensions,} from 'react-native'
...
export default function ReelsComponents() {
  const data = [
    {
      title: 'Title here',
      url: require('../assets/video/VID_20231116_194412_323.mp4'),
    ...
    <View style={styles.video}>
      ...
      <View style={styles.container}>
        <View style={{flexDirection:"row",alignItems:'center',height:"20%",top:"32%"}}>
          <Image style={{height:30,width:30,borderRadius:15,marginLeft:12}} source={require("../assets/img/Logo.jpg")}/>
        ...
        <View style={styles.boxIcon}>
          <TouchableOpacity onPress={handleLike}>
            <Image style={[styles.icons, liked ? styles.liked : null]} source={require("../assets/icons/like2.png")} />
          </TouchableOpacity>
          <TouchableOpacity onPress={handlecomment}>
            <Image style={[styles.icons, commentclose ? styles.liked : null]} source={require("../assets/icons/comment.png")} />
          </TouchableOpacity>
          <TouchableOpacity onPress={handleShare}>
            <Image style={[styles.icons, share ? styles.liked : null]} source={require("../assets/icons/share.png")} />
          </TouchableOpacity>
          <TouchableOpacity onPress={handlesave}>
          </TouchableOpacity>
          <Image style={[styles.icons, saved ? styles.liked : null]} source={require("../assets/icons/save.webp")} />
        </View>
