    ...
    return (
        <Animatable.View animation={"slideInRight"} duration={100} style={{ flex: 1, alignItems: 'center', width: "100%" }}>
            ...
            <TouchableOpacity style={{ height: 70, flexDirection: "row", width: "100%", alignItems: 'center', gap: 20, margin: 2 }}>
                <Image style={{ height: 40, width: 40, borderRadius: 20, marginLeft: 20 }} source={require("../assets/img/car.jpg")} />
                <View>
            ...
            <TouchableOpacity style={{ height: 70, flexDirection: "row", width: "100%", alignItems: 'center', gap: 20, margin: 2 }}>
                <Image style={{ height: 40, width: 40, borderRadius: 20, marginLeft: 20 }} source={require("../assets/img/images.jpg")} />
                <View>
